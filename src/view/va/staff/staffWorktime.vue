    ...
    export default {
        data() {
            return {
                ...
                typeList: [
                    {name: '请假', icon:'el-icon-circle-close-outline', color: 'rgba(174,174,174,0.7)'},
                    {name: '正常', icon:'el-icon-check', color: 'rgba(0,238,45,0.7)'},
                    {name: '未打卡', icon:'el-icon-circle-close', color: 'rgba(255,60,60,0.7)'},
                    {name: '休班', icon:'el-icon-remove-outline', color: 'rgba(174,174,174,0.7)'},
                    {name: '迟到', icon:'el-icon-arrow-down', color: 'rgba(255,222,0,0.7)'},
                    {name: '早退', icon:'el-icon-arrow-up', color: 'rgba(255,150,0,0.7)'},
                    {name: '迟到早退', icon:'el-icon-close', color: 'rgba(255,222,0,0.7)'},
                ],
                typeValue: [],
                loadDay: false,
